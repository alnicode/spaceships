...
import com.alnicode.spaceships.model.persistence.mapper.RoboticSpaceshipMapper;
import com.alnicode.spaceships.model.persistence.repository.RoboticSpaceshipRepository;
...
public class RoboticSpaceshipServiceImpl implements RoboticSpaceshipService {
    ...
    @Override
    public void touchDown(long id) {
        final var entity = repository.findById(id);

        if (entity.isPresent()) {
            entity.get().touchDown();
    ...
    @Override
    public void sendImages(long id) {
        final var entity = repository.findById(id);

        if (entity.isPresent()) {
            entity.get().sendImages();
